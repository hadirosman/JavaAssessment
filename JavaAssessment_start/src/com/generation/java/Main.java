...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        //DONE! TODO Loop through the student enrolled courses, and use the scanner object to get the course ID to insert
        // the course grade
        if (student == null) {
            return;
        }
    ...
    private static void showPassedCourses(StudentService studentService, Scanner scanner )
    {
        ...
        if (passedCourses.isEmpty()) {
            System.out.println("No courses passed: " + student.getName());
        } else {
            System.out.println("Passed courses for: " + student.getName() + ":");
